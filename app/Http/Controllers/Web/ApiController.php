...
class ApiController extends Controller
{
    ...
    {
        $response = Http::post('https://tugas89.herokuapp.com/api/registrasi', $request->input())->json();
    ...
    {
        $response = Http::post('https://tugas89.herokuapp.com/api/login', $request->input())->json();
    ...
    {
        $response = Http::get('https://tugas89.herokuapp.com/api/getuser/' . $user_id)->json();
        return view('Api.edit', compact('response'));
    }

    public function editUserApi(Request $request, $user_id)
    {
        $response = Http::put('https://tugas89.herokuapp.com/api/edit/' . $user_id, $request->input())->json();
